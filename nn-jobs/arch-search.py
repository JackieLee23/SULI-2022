...
architectures = [[354, 256, 256, 256, 256, 3],
                 [354, 252, 210, 168, 126, 84, 42, 3],
                 [354, 256, 192, 128, 64, 3],
                 [354, 256, 128, 64, 32, 16, 8, 3],
                 [354, 256, 256, 256, 3],
                 [354, 256, 128, 64, 32, 3],
                 [354, 128, 128, 128, 128, 3],
                 [354, 255, 204, 153, 102, 51, 3],
                 [354, 256, 128, 64, 32, 16, 3],
                 [354, 128, 96, 64, 32, 3],
                 [354, 128, 128, 128, 3],
                 [354, 255, 170, 85, 3]]
######################################################
...
layer_sizes = architectures[step_num - 1]
learning_rate = 0.001
batch_size = 128
schedule_factor = 0.5
